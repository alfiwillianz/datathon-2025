...
training_args = TrainingArguments(
    output_dir="StudentModels/Adapters/qwen2.5-0.5b-lora/",
...
plt.xlabel('Steps')
plt.ylabel('Loss')
plt.title('Qwen2.5-0.5B LoRA Training Loss')
plt.legend()
plt.tight_layout()
plt.savefig('qwen2.5-0.5b_training_loss.png')
print("📊 Saved loss plot to qwen2.5-0.5b_training_loss.png")
