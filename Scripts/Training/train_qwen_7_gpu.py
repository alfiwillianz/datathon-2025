...
# Tokenizer
# =========================
model_dir = "StudentModels/qwen_models/2.5-7B/"  # Updated path
...
training_args = TrainingArguments(
    output_dir="StudentModels/Adapters/qwen2.5-7b-qlora/",  # Updated path
...
plt.xlabel('Steps')
plt.ylabel('Loss')
plt.title('Qwen2.5-7B LoRA Training Loss')
plt.legend()
plt.tight_layout()
plt.savefig('qwen2.5-7b_training_loss.png')
print("📊 Saved loss plot to qwen2.5-7b_training_loss.png")
